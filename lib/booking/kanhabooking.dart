...
class kanhabooking extends StatefulWidget {
  const kanhabooking({super.key});

  @override
  State<kanhabooking> createState() => _kanhabookingState();
}

class _kanhabookingState extends State<kanhabooking> {
  @override
          ...
          child: Column(
            children: [
              buildBookingCard(
                ...
                title: 'Hotel',
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const kanhabooking2()));
                },
              ...
              buildBookingCard(
                ...
                title: 'Safari',
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const ParkTicketKanha1()));
                },
                imageHeight: imageHeight,
                titleFontSize: titleFontSize,
                buttonFontSize: buttonFontSize,
              ...
              buildBookingCard(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const KanhaActivity()));
                },
                imageHeight: imageHeight,
                titleFontSize: titleFontSize,
                buttonFontSize: buttonFontSize,
