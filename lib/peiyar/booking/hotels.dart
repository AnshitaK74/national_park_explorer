...
import 'package:internship/peiyar/booking/hotels2.dart';
import 'package:internship/peiyar/booking/other.dart';
import 'package:internship/peiyar/booking/safari.dart';

class periyarbooking extends StatefulWidget {
  const periyarbooking({super.key});

  @override
  State<periyarbooking> createState() => _periyarbookingState();
}

class _periyarbookingState extends State<periyarbooking> {
  @override
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              buildBookingCard(
                imagePath: 'assets2/images2/91.jpeg',
                title: 'Hotel',
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const PeriyarBookingHotels()));
                },
              ...
              buildBookingCard(
                imagePath: 'assets2/images2/92.jpeg',
                title: 'Safari',
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const PeriyarSafar()));
                },
                imageHeight: imageHeight,
                titleFontSize: titleFontSize,
                buttonFontSize: buttonFontSize,
              ...
              buildBookingCard(
                imagePath: 'assets2/images2/93.jpeg',
                title: 'Other Activities',
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const PeriyarActivity1()));
                },
                imageHeight: imageHeight,
                titleFontSize: titleFontSize,
                buttonFontSize: buttonFontSize,
