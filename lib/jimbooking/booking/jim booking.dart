...
import 'package:internship/jimbooking/booking/jimhotels.dart';
import 'package:internship/jimbooking/booking/jimother.dart';
import 'package:internship/jimbooking/booking/jimsafari.dart';

class JimParkBooking extends StatefulWidget {
  const JimParkBooking({super.key});

  @override
  State<JimParkBooking> createState() => _JimParkBookingState();
}

class _JimParkBookingState extends State<JimParkBooking> {
  @override
          ...
          child: Column(
            children: [
              buildBookingCard(
                ...
                title: 'Hotel',
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const JimBookingHotel()));
                },
              ...
              buildBookingCard(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const JimSafariBooking()));
                },
                imageHeight: imageHeight,
                titleFontSize: titleFontSize,
                buttonFontSize: buttonFontSize,
              ...
              buildBookingCard(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => jim()));
                },
                imageHeight: imageHeight,
                titleFontSize: titleFontSize,
                buttonFontSize: buttonFontSize,
