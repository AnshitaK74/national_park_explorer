...
import 'package:internship/ranthombore/booking/hotels.dart';
import 'package:internship/ranthombore/booking/safari.dart';
import 'package:internship/ranthombore/booking/others.dart';

class RanthomboreParkBooking extends StatefulWidget {
  const RanthomboreParkBooking({super.key});

  @override
  State<RanthomboreParkBooking> createState() => _RanthomboreParkBookingState();
}

class _RanthomboreParkBookingState extends State<RanthomboreParkBooking> {
  @override
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              buildBookingCard(
                imagePath: 'assets2/images2/11.jpeg',
                title: 'Hotel',
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const RanthomboreBookingHotel()));
                },
              ...
              buildBookingCard(
                ...
                title: 'Safari',
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const SafariBooking()));
                },
                imageHeight: imageHeight,
                titleFontSize: titleFontSize,
                buttonFontSize: buttonFontSize,
              ...
              buildBookingCard(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const RanthamboreActivities()));
                },
                imageHeight: imageHeight,
                titleFontSize: titleFontSize,
                buttonFontSize: buttonFontSize,
